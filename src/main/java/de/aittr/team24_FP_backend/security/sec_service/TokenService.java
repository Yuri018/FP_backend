...
import de.aittr.team24_FP_backend.repositories.RoleRepository;
...
public class TokenService {
    ...
    public String generateAccessToken(@Nonnull UserLogin user) {
    ...
    public String generateRefreshToken(@Nonnull UserLogin user) {
        LocalDateTime currentDate = LocalDateTime.now();
        Instant expirationInstant = currentDate.plusDays(15).atZone(ZoneId.systemDefault()).toInstant();
        Date expirationDate = Date.from(expirationInstant);
