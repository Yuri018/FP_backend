...
public class MuenchenDeNewsDTO {
    ...
    public MuenchenDeNewsDTO() {
    }

    public MuenchenDeNewsDTO(Integer id, String title, String shortDescription, String content, String imgUrl, String imgCopyright, String categoryTitle) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        MuenchenDeNewsDTO that = (MuenchenDeNewsDTO) o;
