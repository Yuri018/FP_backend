...
public class BerlinDeNewsParsObj {
    ...
    public BerlinDeNewsParsObj() {
    }

    public BerlinDeNewsParsObj(Integer id, String title, String shortDescription, String content, String imgUrl, String imgCopyright, LocalNewsCategory localNewsCategory) {
        this.id = id;
        this.title = title;
    ...
    public LocalNewsCategory getBerlinNewsCategory() {
        return localNewsCategory;
    }

    public void setBerlinNewsCategory(LocalNewsCategory localNewsCategory) {
        this.localNewsCategory = localNewsCategory;
    }
    ...
    public boolean equals(Object o) {
        ...
        BerlinDeNewsParsObj that = (BerlinDeNewsParsObj) o;
