...
@Entity
@Table(name = "berlin_exhibitions_news")
public class BerlinDeExhibitionsParsObj {
    ...
    public BerlinDeExhibitionsParsObj() {
    }

    public BerlinDeExhibitionsParsObj(String title, String content, String imageUrl, String imgCopyright) {
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        BerlinDeExhibitionsParsObj that = (BerlinDeExhibitionsParsObj) o;
    ...
    public String toString() {
        return "BerlinDeExhibitionsParsObj{" +
                "id=" + id +
                ", title='" + title + '\'' +
                ", content='" + content + '\'' +
                ", imageUrl='" + imageUrl + '\'' +
